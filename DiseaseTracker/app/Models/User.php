...
class User extends Authenticatable
{
    ...
    protected $fillable = [
        ...
        'email',
        'password', 'status', 'vaccinated', 'last_login'
    ];
    ...
    */
    public function contactsOfMine(){
        return $this->belongsToMany(User::class, 'contacts','requester_id', 'addressee_id');
    }
    ...
    */
    public function contactsOf(){
        return $this->belongsToMany(User::class, 'contacts', 'addressee_id', 'requester_id');
    }
    ...
    */
    ...
    public function organizations(){
        return $this->hasManyThrough(Organization::class, Organization_Member::class, 'member_id', 'organization_id', 'id','organization_id');
    }
    ...
    public function organizationOwner(){
        return $this->belongsTo(Organization::class, 'leader_id', 'id');
    }
